...
import oceannZeroimg1 from "../Componants/Assets/privacy-img/privecy-img1.png";
  ...
  return (
    <>
      ...
      <div className="  flex flex-col items-center  justify-center h-full text-left  ">
        <h1 className="text-md sm:text-md md:text-xl font-semibold text-[#003E78] m-5">
          <span className="border-b-4 border-[#F39C12]  ">Introd</span>
          uction
        </h1>
        <p className="text-xs sm:text-sm md:text-md w-[90%]  ">
      ...
      <div className="  flex flex-col items-center justify-center  ">
        <h1 className="text-md sm:text-md md:text-xl font-semibold text-[#003E78] m-5">
          <span className="border-b-4 border-[#F39C12]  ">Interpr</span>
          etation and Definitions
        </h1>
        <h1 class="text-sm sm:text-md md:text-lg w-[90%] text-left font-semibold m-5">
            Interpretation
          </h1>
          <ul className=" text-xs sm:text-sm md:text-md  list-disc items-start w-[85%] ">
          ...
          <p className="text-xs sm:text-sm md:text-md  w-[90%] text-left ">
        ...
        <ul className=" text-xs sm:text-sm md:text-md  list-disc items-start w-[85%] ">
          ...
          <li className="text-xs sm:text-sm md:text-md  ">
            ...
            this Agreement) refers to THE OCEANN AI TECHNOLOGY, FZCO Dubai,
            DUBAI, UAE.
          </li>
          <li className="text-xs sm:text-sm md:text-md  ">
          ...
          <li className="text-xs sm:text-sm md:text-md  ">
            Website refers to theoceann.com, accessible from
            https://theoceann.com/
          </li>
          <li className="text-xs sm:text-sm md:text-md  ">
      ...
      <div className="  flex flex-col items-center justify-center  text-center  ">
        <h1 className="text-md sm:text-md md:text-xl font-semibold text-[#003E78] m-5">
          <span className="border-b-4 border-[#F39C12]  ">Collect</span>
          ing and Using Your Personal Data
        </h1>
        <h3 className="text-sm sm:text-md md:text-lg w-[90%] text-left m-5 font-semibold ">
          Types of Data Collected
        </h3>
        <h3 className="text-sm sm:text-md md:text-lg w-[90%] text-left m-2 font-semibold ">
          Personal Data
        </h3>
        <p className="text-xs sm:text-sm md:text-md w-[90%] text-left ">
        ...
        <ul className="text-xs sm:text-sm md:text-md  list-disc items-start w-[85%] text-left ">
          <li className="text-xs sm:text-sm md:text-md ">Email address</li>
          <li className="text-xs sm:text-sm md:text-md  ">
            First name and last name
          </li>
          <li className="text-xs sm:text-sm md:text-md  ">Phone number</li>
          <li className="text-xs sm:text-sm md:text-md  ">
            Address, State, Province, ZIP/Postal code, City
          </li>
          <li className="text-xs sm:text-sm md:text-md  ">Usage Data</li>
        </ul>
        <p className="text-xs sm:text-sm md:text-md w-[90%] text-left ">
          Usage Data
          <br />
        ...
        <p className="text-xs sm:text-sm md:text-md w-[90%] text-left ">
          ...
          <span className="underline">Free Privacy Policy website </span>
          article.
          <br />
      ...
      <div className="  flex flex-col items-center justify-center  text-center  ">
        <h1 className="text-md sm:text-md md:text-xl font-semibold text-[#003E78] m-5">
          <span className="border-b-4 border-[#F39C12]  "> Use of</span> Your
          Personal Data
        </h1>
        <p className="text-xs sm:text-sm md:text-md w-[90%] text-left ">
      ...
      <div className="  flex flex-col items-center justify-center  text-center  ">
        <h1 className="text-md sm:text-md md:text-xl font-semibold text-[#003E78] m-5">
          <span className="border-b-4 border-[#F39C12]  ">Transf</span>er of
          Your Personal Data
        </h1>
        <p className="text-xs sm:text-sm md:text-md w-[90%] text-left ">
      ...
      <div className="  flex flex-col items-center justify-center  text-center  ">
        <h1 className="text-md sm:text-md md:text-xl font-semibold text-[#003E78] m-5">
          <span className="border-b-4 border-[#F39C12]  ">Delet</span>e Your
          Personal Data
        </h1>
        <p className="text-xs sm:text-sm md:text-md w-[90%] text-left ">
      ...
      <div className="  flex flex-col items-center justify-center  text-center  ">
        <h1 className="text-md sm:text-md md:text-xl font-semibold text-[#003E78] m-5">
          <span className="border-b-4 border-[#F39C12]  ">Disclo</span>sure of
          Your Personal Data
        </h1>
        <h3 className="text-sm sm:text-md md:text-lg w-[90%] text-left ">
      ...
      <div className="  flex flex-col items-center justify-center  text-center  ">
        <h1 className="text-md sm:text-md md:text-xl font-semibold text-[#003E78] m-5">
          <span className="border-b-4 border-[#F39C12]  ">Childre</span>n's
          Privacy
        </h1>
        <p className="text-xs sm:text-sm md:text-md w-[90%] text-left ">
      ...
      <div className="  flex flex-col items-center justify-center  text-center  ">
        <h1 className="text-md sm:text-md md:text-xl font-semibold text-[#003E78] m-5">
          <span className="border-b-4 border-[#F39C12]  ">Links t</span>o Other
          Websites
        </h1>
        <p className="text-xs sm:text-sm md:text-md w-[90%] text-left ">
      ...
      <div className="  flex flex-col items-center justify-center  text-center  ">
        <h1 className="text-md sm:text-md md:text-xl font-semibold text-[#003E78] m-5">
          <span className="border-b-4 border-[#F39C12]  ">Chang</span>es to this
          Privacy Policy
        </h1>
        <p className="text-xs sm:text-sm md:text-md w-[90%] text-left ">
      ...
      <div className="  flex flex-col items-center justify-center  text-center  ">
        <h1 className="text-md sm:text-md md:text-xl font-semibold text-[#003E78] m-5">
          <span className="border-b-4 border-[#F39C12]  ">Contac</span>t Us
        </h1>
        <p className="text-xs sm:text-sm md:text-md w-[90%] text-left ">
        ...
        <ul className="text-xs sm:text-sm md:text-md  list-disc items-start w-[85%] text-left ">
          <li className="text-xs sm:text-sm md:text-md ">
          By email: commercial@theoceann.com
          </li>
          <li className="text-xs sm:text-sm md:text-md  ">
          By visiting this page on our website: https://theoceann.com/contact
          </li>
